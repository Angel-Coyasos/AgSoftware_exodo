...
class bloquesHomev1 implements DataPatchInterface, PatchRevertableInterface 
{
    ...
    public function apply()
    {
        ...
        $data[ 'pree-footer' ] = [
            "title" => "pree footer",
            "identifier" => "pree-footer",
            "content" => file_get_contents(__DIR__.'/html/preFooter.html'),
            "is_active" => "1"
        ];
        $data[ 'big-footer-weltpixel' ] = [
            "title" => "big footer weltpixel",
            "identifier" => "big-footer-weltpixel",
